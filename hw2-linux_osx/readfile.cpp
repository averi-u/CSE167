      ...
      if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
        ...
        // Note that no transforms/stacks are applied to the colors. 
          ...
          if (validinput) {
            ...
            eyeinit.y = values[1];
            eyeinit.z = values[2];
            upinit.x, upinit.y, upinit.z = values[3], values[4], values[5];
            center.x, center.y, center.z = values[6], values[7], values[8];
        ...
        // Also look at demo.txt to get a sense of why things are done this way.
          ...
          if (validinput) {
            ...
            mat4 matrixTrans = Transform::translate(values[0], values[1], values[2]);

            rightmultiply(matrixTrans, transfstack);
          }
        }
        else if (cmd == "scale") {
          validinput = readvals(s,3,values); 
          if (validinput) {
            ...
            // You might want to use helper functions on top of file.  
            // Also keep in mind what order your matrix is!
            mat4 matrixTrans = Transform::scale(values[0], values[1], values[2]);
            rightmultiply(matrixTrans, transfstack);
          ...
          if (validinput) {
            ...
            mat3 mr = Transform::rotate(values[3], axis);
            mat4 rot = mat4(
